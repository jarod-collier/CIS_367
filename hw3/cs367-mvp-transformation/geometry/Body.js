...
export default class Body extends GeometricObject {
     ...
     */
    constructor({ length = 1.5, height = 2, width = .5}) {
        super();
        ...
        this.vertices.push([width, length, 0]);

        /* 2) top front right */
        this.vertices.push([width, length, height]);

        /* 3) top front left */
        this.vertices.push([width, 0, height]);

        /* 4) Bottom back right */
        this.vertices.push([0, length, 0]);

        /* 5) Bottom back left */
        this.vertices.push([0, 0, 0]);

        /* 6) top back right */
        this.vertices.push([0, length, height]);
